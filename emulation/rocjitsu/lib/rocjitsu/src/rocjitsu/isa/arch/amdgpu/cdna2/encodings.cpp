...
bool Vop1::has_encoded_dpp() const {
  if (!(inst_.src0 == amdgpu::SRC_DPP))
    return false;
  return (inst_.op >= 0 && inst_.op <= 1) || (inst_.op >= 3 && inst_.op <= 8) ||
         (inst_.op >= 10 && inst_.op <= 15) || (inst_.op >= 17 && inst_.op <= 24) ||
         (inst_.op >= 26 && inst_.op <= 36) || inst_.op == 39 ||
         (inst_.op >= 41 && inst_.op <= 52) || inst_.op == 55 ||
