...
TEST(CfgAnalysis, Gfx1250ExplicitVgprWriteInvalidatesOnlyItsDestinationBank) {
  ...
  constexpr auto write_bank_zero =
      gfx1250::build_vop3(gfx1250::kVMovB64Vop3, {.vdst = 0, .src0 = 256 + 2});
  std::vector<uint32_t> words = {
      0xBE804700u, // 0x00: s_get_pc_i64 s[0:1].
      0xA980FE00u,
      72u,
...
TEST(CfgAnalysis, Gfx1250ExactCalleeSummaryPreservesUnwrittenCallerSavedLaneStash) {
  constexpr uint16_t kReturnSreg = 30;
  constexpr auto unrelated_write =
      gfx1250::build_vop1(gfx1250::kVMovB32Vop1, {.src0 = 128, .vdst = 2});
...
TEST(CfgAnalysis, Gfx1250ExactCalleeSummaryPreservesBankedLaneStash) {
  ...
  constexpr auto set_all_banks_zero = gfx1250::build_sopp(gfx1250::kSSetVgprMsbSopp, {.simm16 = 0});
  constexpr auto clobber_bank_zero =
      gfx1250::build_vop1(gfx1250::kVMovB32Vop1, {.src0 = 128, .vdst = 44});
  std::vector<uint32_t> words = {
      0xBE804700u, // 0x00: s_get_pc_i64 s[0:1].
      0xA980FE00u, 60u,
...
TEST(CfgAnalysis, Gfx1250ImmediateModeWriteKeepsLaneStashBankKnown) {
  ...
  constexpr auto set_mode_bit25 =
      gfx1250::build_sopk(gfx1250::kSSetregImm32B32Sopk, {.simm16 = kModeBit25Hwreg});
  std::vector<uint32_t> words = {
      0xBE804700u, // 0x00: s_get_pc_i64 s[0:1].
      0xA980FE00u,
      60u,
...
TEST(CfgAnalysis, Gfx1250PcPairCopyReachesConsumer) {
  ...
  constexpr uint16_t kReturnSreg = 30;
  constexpr auto getpc = gfx1250::build_sop1(gfx1250::kSGetPcI64Sop1, {.sdst = kSourceSreg});
  constexpr auto add = gfx1250::build_sop2(
      gfx1250::kSAddNcU64Sop2, {.ssrc0 = kSourceSreg, .ssrc1 = 254, .sdst = kSourceSreg});
  constexpr auto copy = gfx1250::build_sop1(
      gfx1250::kSMovB64Sop1, {.ssrc0 = static_cast<uint8_t>(kSourceSreg), .sdst = kCopiedSreg});
  std::vector<uint32_t> words = {
...
TEST(CfgAnalysis, Gfx1250DirectCallOverwritesPcBuilderInReturnPair) {
  constexpr uint16_t kReturnSreg = 30;
  constexpr auto getpc = gfx1250::build_sop1(gfx1250::kSGetPcI64Sop1, {.sdst = kReturnSreg});
  constexpr auto add = gfx1250::build_sop2(
      gfx1250::kSAddNcU64Sop2, {.ssrc0 = kReturnSreg, .ssrc1 = 254, .sdst = kReturnSreg});
  std::vector<uint32_t> words = {
...
TEST(CfgAnalysis, Gfx1250SwapPcOverwritesPcBuilderInReturnPair) {
  ...
  constexpr auto getpc = gfx1250::build_sop1(gfx1250::kSGetPcI64Sop1, {.sdst = kTargetSreg});
  constexpr auto add = gfx1250::build_sop2(
      gfx1250::kSAddNcU64Sop2, {.ssrc0 = kTargetSreg, .ssrc1 = 254, .sdst = kTargetSreg});
  std::vector<uint32_t> words = {
      getpc[0], // 0x00: s_get_pc_i64 s[0:1].
      add[0], 24u,
...
TEST(CfgAnalysis, Gfx1250CalleeSummaryRejectsRepurposedReturnPair) {
  ...
  constexpr auto set_mode_zero = gfx1250::build_sopp(gfx1250::kSSetVgprMsbSopp, {.simm16 = 0});
  constexpr auto get_stashed_target =
      gfx1250::build_sop1(gfx1250::kSGetPcI64Sop1, {.sdst = kTargetSreg});
  constexpr auto add_stashed_target = gfx1250::build_sop2(
      gfx1250::kSAddNcU64Sop2, {.ssrc0 = kTargetSreg, .ssrc1 = 254, .sdst = kTargetSreg});
  constexpr auto save_return =
      gfx1250::build_sop1(gfx1250::kSMovB64Sop1,
                          {.ssrc0 = static_cast<uint8_t>(kReturnSreg), .sdst = kSavedReturnSreg});
  constexpr auto get_tail_target =
      gfx1250::build_sop1(gfx1250::kSGetPcI64Sop1, {.sdst = kReturnSreg});
  constexpr auto add_tail_target = gfx1250::build_sop2(
      gfx1250::kSAddNcU64Sop2, {.ssrc0 = kReturnSreg, .ssrc1 = 254, .sdst = kReturnSreg});
  constexpr auto clobber_stash =
      gfx1250::build_vop1(gfx1250::kVMovB32Vop1, {.src0 = 128, .vdst = 192});
  std::vector<uint32_t> words = {
