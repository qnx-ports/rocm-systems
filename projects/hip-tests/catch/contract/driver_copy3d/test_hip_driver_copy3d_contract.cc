...
HIP_TEST_CASE(Contract_DriverCopy3D_HipDrvMemcpy3D_HostToDevice_RoundTripsExtent) {
...
HIP_TEST_CASE(Contract_DriverCopy3D_HipDrvMemcpy3D_DeviceToDevice_PreservesBytes) {
  hip::contract::ContractCleanup cleanup;
...
HIP_TEST_CASE(Contract_DriverCopy3D_HipDrvMemcpy3D_ZeroExtent_IsNoOp) {
  hip::contract::ContractCleanup cleanup;
...
HIP_TEST_CASE(Contract_DriverCopy3DAsync_HipDrvMemcpy3DAsync_HostToDevice_VisibleAfterSync) {
  hip::contract::ContractCleanup cleanup;
...
HIP_TEST_CASE(Contract_DriverCopy3D_HipDrvMemcpy3D_NullInnerPointer_IsRejected) {
  hip::contract::ContractCleanup cleanup;
