...
HIP_TEST_CASE(Contract_ModuleLoadFile_HipModuleLoad_LoadNullModule_IsRejected) {
...
HIP_TEST_CASE(Contract_ModuleLoadFile_HipModuleLoad_LoadNullFilename_IsRejected) {
...
HIP_TEST_CASE(Contract_ModuleLoadFile_HipModuleLoad_LoadEmptyFilename_IsRejected) {
  hipModule_t module = nullptr;
...
HIP_TEST_CASE(Contract_ModuleLoadFile_HipModuleLoad_LoadMissingFile_IsRejected) {
  hipModule_t module = nullptr;
...
HIP_TEST_CASE(Contract_ModuleLoadFile_HipModuleLoadFatBinary_NullFatbin_IsRejected) {
  hipModule_t module = nullptr;
...
HIP_TEST_CASE(Contract_ModuleLoadFile_HipModuleLoadFatBinary_NullModule_IsRejected) {
