...
HIP_TEST_CASE(Contract_PitchedMemory_HipMallocPitch_Default_ReturnsPitchAtLeastWidth) {
...
HIP_TEST_CASE(Contract_PitchedMemory_HipMemcpy2D_Default_HostDeviceRoundTripsRows) {
  hip::contract::ContractCleanup cleanup;
...
HIP_TEST_CASE(Contract_PitchedMemory_HipMemcpy2D_Default_SingleRowRoundTripsBytes) {
  hip::contract::ContractCleanup cleanup;
...
HIP_TEST_CASE(Contract_PitchedMemory_HipFree_PitchedAllocation_Succeeds) {
  void* device_ptr = nullptr;
  size_t pitch = 0;
