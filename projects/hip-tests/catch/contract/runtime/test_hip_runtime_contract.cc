...
HIP_TEST_CASE(Contract_Runtime_HipGetDevice_Default_ReturnsValidOrdinal) {
  int device_count = 0;
  int device = -1;
...
HIP_TEST_CASE(Contract_Runtime_HipSetDevice_SetCurrentDevice_RoundTripsThroughGetDevice) {
...
HIP_TEST_CASE(Contract_Runtime_HipGetErrorName_Success_ReturnsSuccessString) {
...
HIP_TEST_CASE(Contract_Runtime_HipGetErrorString_Success_ReturnsSuccessString) {
