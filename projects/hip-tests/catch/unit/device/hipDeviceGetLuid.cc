 ...
 *    on other platforms it matches CUDA by returning `hipErrorNotSupported`
 *    without writing the output parameters.
 * Test source
 * ------------------------
 ...
 *    hipGetDeviceProperties reports an all-zero LUID and zero node mask (parity
 *    with CUDA).
 * Test source
 * ------------------------
 *  - unit/device/hipDeviceGetLuid.cc
